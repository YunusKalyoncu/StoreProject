...
using StoreProject.BusinessLayer.ValidationRules.CategoryValidationRules;
using StoreProject.DataAccessLayer.Abstract;
using StoreProject.DataAccessLayer.Conrete;
...
namespace StoreProject.PresentationLayer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IValidator<CreateCategoryDto>, CategoryCreateValdator>();
